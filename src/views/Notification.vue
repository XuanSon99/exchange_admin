                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    <v-container>
                                        ...
                                        <v-row>
                                            <v-col cols="12">
                                                <v-select label="Màu sắc" v-model="editedItem.color" :items="colors">
...
export default {
    ...
    methods: {
        getData() {
            this.desserts = [];
            this.CallAPI("get", "manage/notification", {}, (response) => {
        ...
        deleteItemConfirm() {
            ...
            this.CallAPI(
                "delete",
                "manage/notification/" + this.desserts[this.editedIndex].id,
                {},
                (response) => {
